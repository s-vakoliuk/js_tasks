// - Cтворити 2 форми  по 2 інпути в кожній. Cтворити кнопку при кліку на яку зчитується та виводиться на консоль інформація з цих 2х форм.
...
//  - Створити 3 инпута та кнопку. Один визначає кількість рядків, другий - кількість комірок, третій вміст комірок.
...
let mates = ['дідько', 'лопух', 'попандопуло']; // тут ваш масив слів ))
...
button.addEventListener('click', function () {
    ...
    for (let mate of mates) {
        if (mate === valueInput) {
            alert('Сам такий');
            input.value = '';// очищення рядка після введення
            return;
        }
    }
